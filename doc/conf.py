# -*- coding: utf-8 -*-
#
# desietc documentation build configuration file, created by
...
latex_documents = [
  ('index', 'desietc.tex', u'desietc Documentation',
   u'DESI', 'manual'),
]
...
man_pages = [
    ('index', 'desietc', u'desietc Documentation',
     [u'DESI'], 1)
]
...
texinfo_documents = [
  ('index', 'desietc', u'desietc Documentation',
   u'DESI', 'desietc', 'One line description of project.',
   'Miscellaneous'),
]
